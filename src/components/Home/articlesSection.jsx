...
const ArticlesSection = () => {
    ...
    return (
        <section id="articlesSection" className="relative overflow-hidden bg-gray-50 dark:bg-zinc-900 mb-10 rounded-4xl shadow-[0_2px_8px_0_rgba(99,99,99,0.2)] border border-zinc-200/50 dark:border-zinc-800/50 py-12 px-4 sm:px-6 lg:px-8" style={{ scrollMarginTop: '120px' }}>
